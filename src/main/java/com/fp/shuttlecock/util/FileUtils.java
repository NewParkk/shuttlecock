...
public class FileUtils {
    ...
    public FileRequest uploadFile(final MultipartFile multipartFile) {
        ...
        String fileName = generateSaveFilename(multipartFile.getOriginalFilename());
        String today = LocalDate.now().format(DateTimeFormatter.ofPattern("yyMMdd")).toString();
        String filePath = getFilePath(today) + File.separator + fileName;
     ...
     * @return 업로드 경로
     */
    private String getFilePath(final String addPath) {
