				...
				<form action="/updateUser" method="POST"
					...
					<div class="member-info">
						<div class="profile-picture">
							...
							<input type="file" id="fileInput" name="file" class="custom-file-upload"><br>
						</div>
						<div class="details">
							<h2>
								ID : <input type="text" value="${user.userId}" class="custom-input" readonly disabled>
							</h2>
							<br>
							<h2>
							...
							<br>
							<h2>
								email : <input type="text" name="userEmail" class="custom-input"
									value="${user.userEmail}">
							</h2>
							<br> <input class="update" type="submit" id="update" value="수정"><br>
						</div>
					</div>
					<input type="button" class="delete-btn" id="btnDelete"
						value="회원탈퇴"> <br>
				</form>
				<!-- modal 추가 -->
				<div id="my_modal_delete" class="modal">
					<div class="modal-content">
						...
						<form action="/deleteUser" enctype="multipart/form-data">
							<input type="password" name="pw" placeholder="비밀번호" class="custom-input">
							<p>정말로 삭제하시겠습니까?</p>
