...
.board-table th a.active,
.board-table th a:hover {
    font-weight: bold;
    color: #000; 
}
								...
								<tr>
									<th scope="col" style="text-align: center;"><span
										style="font-size: 12pt;"> 
											<a href = "/LeagueBoardRanking"> 
												전체 기간 </a></span></th>
									<th scope="col" style="text-align: center;"><span
										style="font-size: 12pt;"> 
											<a onclick="setDateRange('2024-01-01', '2024-03-31')">	
												2024 1분기 </a></span></th>
									<th scope="col" style="text-align: center;"><span
										style="font-size: 12pt;"> 
											<a onclick="setDateRange('2024-04-01', '2024-06-30')"> 
												2024 2분기 </a></span></th>
									<th scope="col" style="text-align: center;"><span
										style="font-size: 12pt;">
											<a onclick="setDateRange('2024-07-01', '2024-09-30')"> 
												2024 3분기 </a></span></th>
									<th scope="col" style="text-align: center;"><span
										style="font-size: 12pt;"> 
											<a onclick="setDateRange('2024-10-01', '2024-12-31')">
												2024 4분기 </a></span></th>
								</tr>
